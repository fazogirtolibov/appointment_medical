  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: DoubleIconsAppBar(
        ...
        leftIcon: isLiked ? ActionIcons.favorite : ActionIcons.favoriteBorder,
      ),
      body: Padding(
                    ...
                    return Column(
                      children: [
                        ContainerItems(
                          ...
                          cardioSpecialist: widget.doctorModel.aboutDoctor,
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            padding: const EdgeInsets.only(
                                    left: 24, right: 12, top: 4, bottom: 4)
                                .r,
