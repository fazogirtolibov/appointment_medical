  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          padding: EdgeInsets.symmetric(vertical: 10.h, horizontal: 24.h),
          child: Stack(
            children: [
                  ...
                  GlobalButton(
                    ...
                    onTap: (() {
                      ...
                      SuccessDialog(
                          ...
                          desc:
                              "Your appointment booking successfully completed. Doctor will message you soon.");
                    }),
                    isSmall: false,
                  ),
                ],
    ...
    return Row(
      children: [
        Text(
          tr(text),
          style: MyTextStyle.sfProSemiBold.copyWith(
              color: MyColors.neutral1.withOpacity(0.8), fontSize: 20.sp),
        ),
        Text(
          " *",
          style: MyTextStyle.sfProSemiBold
              .copyWith(color: MyColors.tertiary2, fontSize: 20.sp),
        ),
      ],
    );
  }
