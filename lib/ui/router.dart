...
class MyRouter {
  static Route? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case signInOrSignUp:
        return navigateTo(const SignInOrSignUpScreen());
      case loginPage:
      ...
      case languageRoute:
        return navigateTo(const LanguageScreen());
      case favouritesRoute:
        return navigateTo(const FavouritesScreen());
      case topDoctorsRoute:
        return navigateTo(const TopDoctorsScreen());
      case doctorsSearchRoute:
        return navigateTo(const DoctorsSearchScreen());
      case specialistsRoute:
        return navigateTo(const SpecialistsScreen());
      ...
      case bookPatientDetailsRoute:
        return navigateTo(const BookingPatientDetails());
      ...
      case settingsNotif:
        return navigateTo(const NotificationSettingsScreen());
      case settingsSecure:
        return navigateTo(const SecuritySettingsScreen());
      case settingsAppear:
        return navigateTo(const AppearanceSettingsScreen());
      ...
      case historyRoute:
        return navigateTo(const HistoryPage());
